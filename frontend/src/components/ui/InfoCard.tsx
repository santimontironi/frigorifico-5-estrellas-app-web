...
const InfoCard = ({ icon, title, description, comingSoon = false }: InfoCardProps) => {
  ...
  return (
    <div className="group relative overflow-hidden bg-[#121212] border border-white/8 rounded-xl p-6 md:p-7 transition-all duration-300 hover:border-[#9B2335]/50 hover:bg-[#1B1417] hover:-translate-y-0.5">
